...
observeEvent(input$btn_child_modal, 
                 ...
                 p("The information shown on the numbers of children eligible for routine preschool reviews is taken from the",
                   ...
                   tags$a(href="https://www.ndc.scot.nhs.uk/National-Datasets/data.asp?ID=4&SubID=10",
                          "Child Health Systems Programme-PreSchool (CHSP-PS)",  target="_blank"),
                    "."),
  ...
  commentary_first <-
    if (input$measure_select_child == "4_5yr") {
      p("All preschool children should be offered the following health reviews: health visitor first visit, 6-8 week review, 13-15 month review, 27-30 month review, and 4-5 year review. Although the 4-5 year review only became mandated by government policy for children turning 4 from April 2020 onwards.", br(),
        ...
        "Data is shown for Scotland and for NHS Board areas. Due to small numbers of children in the Island Boards, results for NHS Orkney, NHS Shetland, and NHS Western Isles are not shown separately, however the Island Boards are included within the Scotland total. NHS Dumfries & Galloway implemented the 4-5 year review in May 2020, and NHS Highland intends to implement the review in August 2020.  These Boards therefore have very small numbers of 4-5 year reviews currently recorded on the CHSP-PS system, and results for these Boards are not shown separately although they are included within the Scotland total.  NHS Grampian has had difficulty recording reviews given on the CHSP-PS system since the start of the Covid-19 pandemic. Information on children in Grampian has therefore been excluded, and Grampian is not included in the Scotland totals. We hope to include NHS Grampian in future releases once local data recording difficulties are resolved.", br(),
        "Coverage rates based on small numbers are prone to fluctuation. Therefore, in Boards with small numbers of children eligible for review each week, particularly NHS Borders, it is important to consider this when interpreting the rates.
        ")
    } else { 
      p("All preschool children should be offered the following health reviews: health visitor first visit, 6-8 week review, 13-15 month review, 27-30 month review, and 4-5 year review. Although the 4-5 year review only became mandated by government policy for children turning 4 from April 2020 onwards.", br(),
        "The charts show the progression of coverage of the relevant review as children age. The data tables provide the coverage rates at three specific time-points. Data is shown for children who have become eligible for review during the pandemic (from March 2020 onwards). Data is also shown for children who became eligible for review before the pandemic (in 2019 and in January and February 2020) for comparison.", br(), 
...
# This also includes breastfeeding and child development data
 output$child_comments <- renderUI({
     tagList(
       ...
       h2("Child health reviews - 30th September 2020"),
       h4("Breastfeeding"),
