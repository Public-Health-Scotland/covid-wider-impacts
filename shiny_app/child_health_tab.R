...
output$child_health_explorer <- renderUI({
  ...
  commentary_first <-
      p("Data is shown for Scotland and for all NHS Board areas. Data for Health & Social Care Partnerships is also available in the data download. " , 
        "Weekly data is no longer shown in the charts as these were becoming difficult to interpret due to the number of lines, however the weekly data is available in the data download for all areas except the island boards, which have been excluded due to small numbers.  NHS Highland intended to implement the 4-5 year review in August 2020, although no data has come through yet. Therefore they have very small numbers of 4-5 year reviews currently recorded on the CHSP-PS system, and results are not shown separately although they are included within the Scotland total. " ,
