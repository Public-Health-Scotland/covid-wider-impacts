...
output$cancer_commentary <- renderUI({
  tagList(
    ...
    p("A new quarterly chart of cumulative numbers shows that after initial falls in diagnoses, there was some recovery
      ...
      by the end of Quarter 3 (Q3) but this recovered to -12% by the end of 2020.   A similar pattern of maximum fall
    ...
    p("For deprivation, the least and most deprived quintiles are highlighted in colour.  For all cancers except non-melanomas
      ...
      fall of -18% by the end of Q3) and the smallest among the least deprived (-11% by Q3) with a greater recovery in the most
      deprived and some narrowing of the deprivation gap by the end of the year.  Nevertheless, the end-of-year differences in
      numbers of were -9% among the least deprived and -14% in the most deprived.  This general pattern – that reductions in
      ...
      (-11%), greater for those in the most deprived quintile (-20%) but greatest for those in the second most deprived quintile
