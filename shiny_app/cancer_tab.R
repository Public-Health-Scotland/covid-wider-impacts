...
output$cancer_explorer2 <- renderUI({
  ...
  tagList(
    ...
    p(("By the end of 2020 (week ending 27th December), the total number of individuals in Scotland with a pathological confirmation of 
      ...
      strong ("4,572 ", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
      ("individuals (an overall cumulative difference of "),
      strong ("-14% ", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
      (").  That is to say, more than "),
      strong ("4,500 ", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
    ...
    p("The commonest cancers in Scotland are of the lung, breast (females), prostate (males) and colorectal.  By the week
      ...
      "); ",
      strong ("529 ", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
      "fewer prostate cancers (a total fall of ",
      strong ("16.8%", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
      "); and ",
      strong ("822 ", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
...
output$cancer_commentary <- renderUI({
  tagList(
    ...
    h4(strong("Update 28/7/2021: For pathology data to 26th February 2021 (extracted 20/5/2021)")),
    p(("By the end of 2020 (week ending 27th December), the total number of individuals in Scotland with a pathological confirmation of 
       cancer (excluding non-melanoma skin cancers) in Scotland was "),  
      strong ("28,774 ", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
      ("in 2020 and"),
    ...
    tags$ul(
      ...
      tags$li("Malignant melanoma of the skin: The cumulative difference between 2019 and 2020 was",
              strong ("332 ", style = "font-family: 'arial'; font-si20pt; color: #DC143C;"),
              "individuals (",
