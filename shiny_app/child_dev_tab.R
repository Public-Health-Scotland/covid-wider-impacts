...
output$childdev_commentary <- renderUI({
  tagList(
    ...
    p("In this release, information is provided for the first time on the percentage of children with developmental concerns by individual developmental domain. This is in response to the rise in the percentage of children with one or more developmental concerns over the course of 2021.  The data shows that there has been an increase in concerns for gross motor, speech, language & communication, and problem solving at the 13-15 month review. For the 27-30 month review there has been an increase in concerns for speech, language & communication, emotional/behavioural, personal/social, and problem solving. Information by developmental domain is only available at Scotland level due to small numbers in some domains at board level."),
    p("PHS will continue to provide monthly monitoring of these data, and a full annual report with more detailed analysis by developmental domain and population group will be published on 26th April 2022."),
