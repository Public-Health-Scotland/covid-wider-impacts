...
summary_commentary <- 
  tagList(
    ...
    p(h3("7 September 2022")),
    h4("Monthly hospital admissions by ethnic group "),
    tags$ul(
      tags$li("New analysis of hospital admissions by ethnic group has now been added. 
      ...
      tags$li("Ethnicity fields were added to Rapid Preliminary Inpatient Data (RAPID) 
      ...
      tags$li("There was a significant decrease in hospital admissions across all ethnic groups 
              during the lockdowns in Scotland in April 2020 and in the first months of 2021."),
      tags$li("It is important to note that the trends for ethnic groups with small populations 
              should be interpreted with caution as they will be subject to greater variability 
              due to small numbers.")
      ),
    h4("Admissions to Golden Jubilee National Hospital"),
    p("Hospital admissions data for the Golden Jubilee National Hospital is now included. Data for the Golden 
    ...
    tags$ul(
      tags$li("Outpatient appointments fell from the second week of March 2020 onwards: by week 
      ...
      tags$li("This impact was similar across sexes, age groups and deprivation groups. For example, 
              ...
              (-66%). However, by the week ending 26 December 2021, these reductions were 31% for 
              patients aged 85 and over and 28% for patients aged 15–44. "),
      tags$li("There were larger relative falls for surgical (-76%) than medical (-64%) specialties in 
              the early stages of the pandemic. However, by week ending 26 December 2021, medical 
              specialties showed a reduction of over a quarter (-29%), while surgical specialties showed 
              a reduction of over one third (-34%) compared to average values for the same week in 2018–19."),
      ...
      tags$li("Outpatient appointments have generally been recovering from the end of April 2020 onwards 
              but are still not up to pre-pandemic levels. For example, for the week ending 26 December 2021, 
              the total number of appointments remains at around 31% below the average of the same week in 2018–19."),
      tags$li("There has been a very large increase in the number of appointments carried out remotely via 
              telephone and videolink. In week ending 26th December 2021, just under one sixth (15%) of all 
      ...
      tags$li("The impact of the pandemic on outpatient appointments was similar across ethnic groups; however, 
              ...
              appointments with a missing ethnic group, which were 22% lower by December 2021 than the corresponding 
              time in 2018–19."),
      tags$li("In December 2021, appointments for patients with the 'White Scottish' ethnic group recorded were 
              around 4% lower than the corresponding time in 2018–19; the number of appointments in other ethnic 
              groups varies between 28% higher (‘Caribbean or Black’) and 4% lower (‘White Other’). It is important 
              to note that the trends for ethnic groups with small populations should be interpreted with caution, 
              as they will be subject to greater variability due to small numbers.")
      ),
