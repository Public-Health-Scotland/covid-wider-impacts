...
output$tears_commentary <- renderUI({
  tagList(
    ...
    p("The percentage of women resident in NHS Lanarkshire giving birth vaginally to a singleton live or stillborn baby with a cephalic presentation between 37-42 weeks gestation who have a third or fourth degree perineal tear has been above the pre-pandemic average for six successive quarters (covering the period April 2020-Sept 2021).  The pre-pandemic rate was 3% and that for July-Sept 2021 3.7%. It is important to note that some women resident in NHS Lanarkshire receive delivery care from bordering health boards.  At Scotland level the pre-pandemic rate of third and fourth degree perineal tears was 3.5% and that for July-Sept 2021 was 3.2%.  NHS Lanarkshire have been made aware of this data and PHS will continue to monitor."),
