...
output$tears_commentary <- renderUI({
  tagList(
    ...
    p("The percentage of women giving birth vaginally to a singleton live or stillborn baby with a cephalic presentation between 37-42 weeks gestation who have a third or fourth degree perineal tear has been above the pre-pandemic average for six successive quarters (covering the period April 2020-September 2021) in NHS Lanarkshire.  The pre-pandemic rate was 3.0% and that for July-September 2021 3.7%.  At Scotland level the pre-pandemic rate was 3.5% and that for July-September 2021 was 3.2%  NHS Lanarkshire have been made aware of the data and PHS will continue to monitor."),
