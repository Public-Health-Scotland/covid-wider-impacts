          ...
          this week is the 2015 count, rather than the 2015-19 average."),
                 ...
                 showModal(modalDialog( # OUTPATIENTS MODAL
                   ...
                   p("The analyses shown here are derived from person level",
                     ...
                     "Scotland, NHS Board of Treatment, NHS Board of Residence, and",
                     "Health and Social Care Partnership level. ",
                     "'Other' NHS Board of Treatment refers to cases where the NHS Board is unknown.",
                     " 'Other' NHS Board of Residence refers to Other Residential Categories as defined ",
                     "on our ",
