...
output$immun_commentary_section <- renderUI({
  tagList(
    ...
    p("Information on the uptake of pre-school immunisations was updated in this tool on 7 April. The charts and table show annual data for children who became eligible for immunisation in 2019 (before the pandemic) and in this update we have added annual data for children who became eligible in 2020. The data shows that uptake rates for children becoming eligible in 2020 were at least as high as for children becoming eligible for immunisation in 2019. It should be noted that the data recorded for the most recent eligible cohorts, including for 2020, will not be fully complete at this stage. This means that immunisation uptake is likely to be under-reported and will be updated as the data becomes more complete."),
    p("To ensure the display is not over-crowded we have also reduced the number of monthly cohorts shown in the charts and table to the latest available 6 months (August 2020 to January 2021). The full data including monthly data for children eligible from January 2020 and weekly data for children eligible up to week beginning 8 February 2021 are available through the data download. In future updates we plan to add drop-down functionality so that users have the option to choose the time-periods to show in the charts and table."),
    p("Data for a few children are not included in the eligible cohort and uptake figures due to an issue in the source data. The impact of this on the reported rates at Scotland level will be minor."),
