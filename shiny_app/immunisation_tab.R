...
output$immun_commentary_section <- renderUI({
  tagList(
    ...
    p("Although early uptake of each of the vaccines appears noticeably lower for December 2020 compared with previous months, additional investigation of the 2019 baseline data showed comparable decreases were also seen in December 2019. The decreases in early uptake seen in December 2020 are therefore not unusual and are thought to relate to the Christmas holiday period."),
