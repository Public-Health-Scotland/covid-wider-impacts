...
output$immun_table <- renderUI({
  ...
  no_complete_row_six1 <- with(table_data, time_period_eligible %in% c("OCT 2021", "NOV 2021"))
  no_complete_row_mmr <- with(table_data, time_period_eligible %in% c("SEP 2021", "OCT 2021", "NOV 2021"))
