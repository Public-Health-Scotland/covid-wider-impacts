...
output$immun_commentary_1705 <- renderUI({
  tagList(h2("Immunisations - 17th June 2020"), 
          p("Information on the uptake of ",
            ...
            "The third dose of 6-in-1 vaccine is offered at 16 weeks of age. Data before the pandemic, for children eligible in 2019, show that uptake of the second dose by 20 weeks was 72.3%. Uptake by 20 weeks continues to exceed 70% among children who were due their second dose of the 6-in-1 vaccine in March and early April.",br(),
