...
function(input, output, session) {
  ...
  observeEvent(input$new_next,
               showModal(modalDialog(# Cardio A&E MODAL
                 ...
                 tags$ul(
                   tags$li("13 April 2022 - Systemic anti-cancer therapies data update."),
                 ...
                 tags$ul(
                   tags$li("20 April 2022 - Systemic anti-cancer therapies data update."),
                   tags$li("20 April 2022 - Cancer pathology data update."),
