...
output$booking_commentary <- renderUI({
  tagList(
    ...
    p("Fewer women booking for antenatal care could reflect fewer women who fall pregnant choosing to continue with their pregnancy and/or fewer women falling pregnant. It is therefore helpful to consider the data on antenatal booking alongside the data on terminations of pregnancy provided through this tool (see the Commentary on Terminations of pregnancy (link) for more information).  Considering both sets of data, it seems likely that both reasons apply. It is likely that the higher than usual number of terminations of pregnancy provided in March and April 2020 at least partially contributed to the initial fall in the number of women booking for antenatal care from mid-May. Conversely, the subsequent sustained reduction seen in both the number of terminations and the number of women booking for antenatal care is likely to reflect a reduction in the number of women falling pregnant from April 2020 onwards. Further analysis is required to accurately examine trends in the number of women falling pregnant during the COVID-19 pandemic, their subsequent choices to continue with or terminate their pregnancy, and what this means for future trends in the number of births in Scotland."),      
    p("At all Scotland level, prior to COVID-19, the average gestation at which women booked for antenatal care was around 9 and a half weeks of pregnancy.  This fell slightly from the end of March 2020, reaching around 8 and a half weeks by end June 2020 before increasing back to previous levels from August 2020 onwards.  This temporary reduction in the average gestation at booking means that the recent fall seen in the number of women booking is unlikely to be due to women deferring booking until later in their pregnancy.  This further confirms that it is likely that the number of women falling pregnant has been lower than usual from April 2020 onwards."),
