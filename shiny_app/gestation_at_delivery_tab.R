...
output$gestation_explorer <- renderUI({
  ...
  chart_explanation <- 
    tagList(p("We have used ",                      
            ...
            p("On the ‘Percentage of births at stated gestation’ charts above, the dots joined by a solid black line show the percentage of singleton live births with known gestation (18-44 weeks) that were delivered at the stated gestation in each month from January 2018 onwards. The solid blue centreline on the chart shows the average (median) percentage of births in each gestation group over the period January 2018 to February 2020 inclusive (the period before the COVID-19 pandemic in Scotland). The dotted blue centreline continues that average to allow determination of whether there has subsequently been a change in the percentage of births in each gestation group."))
...
plot_gest_trend <- function(measure, shift, trend){  
  ...
  { plot_nodata(height = 50, 
    ...
    # format y axis
    yname <- "Percentage of births at stated gestation"
...
output$gestation_commentary <- renderUI({
  tagList(
    ...
    p("‘Gestation at delivery’ refers to the number of completed weeks pregnant a woman is when she delivers her baby. Babies are ‘due’ at 40 completed weeks gestation. Those born between 37 and 41 weeks inclusive are considered to be born ‘at term’. Babies born at under 37 weeks (more than three weeks before their due date) are considered ",
      tags$a(href = "https://www.nhsinform.scot/ready-steady-baby/labour-and-birth/after-the-birth/premature-babies", "preterm or premature",  target="_blank"), 
      ...
      tags$a(href = "https://www.tommys.org/pregnancy-information/premature-birth/how-long-do-you-stay-in-hospital-after-birth/gestational-age-and-medical-needs", "risk increasing the earlier a baby is born",  target="_blank"),
      ". Babies are also at increased risk when pregnancies extend post-term, in particular the ",
      tags$a(href = "https://www.nhsinform.scot/ready-steady-baby/labour-and-birth/getting-ready-for-the-birth/induced-labour", "risk of stillbirth",  target="_blank"),
    ...
    p("Care for women and babies around the time they are giving birth/being born is an essential, time critical service that cannot be deferred.  As such, it has been provided throughout the COVID-19 pandemic, and maternity and neonatal staff have not been redeployed to support other services.  The way that some elements of this care are provided has changed in response to COVID-19 however, to minimise the risk of infection and to allow services to continue to provide safe care during times when a high number of staff may be off work, for example due to needing to isolate.  Relevant guidance has been issued by the ",
      tags$a(href = "https://www.gov.scot/collections/coronavirus-covid-19-guidance/#health,careandsocialwork", "Scottish Government",  target="_blank"),
      ", the ",
      tags$a(href = "https://www.rcog.org.uk/coronavirus-pregnancy", "Royal College of Obstetricians and Gynaecologists",  target="_blank"),
      ", and the ",
      tags$a(href = "https://www.bapm.org/pages/182-perinatal-covid-19-resources", "British Association for Perinatal Medicine",  target="_blank"),
      "."),
    p("The current evidence suggests that ",
      tags$a(href = "https://www.birmingham.ac.uk/research/who-collaborating-centre/pregcov/about/publications.aspx", "women with COVID-19 are at increased risk of preterm delivery",  target="_blank"),
      ". Conversely, several studies (for example from the ",
      tags$a(href = "https://www.thelancet.com/journals/lanpub/article/PIIS2468-2667(20)30223-1/fulltext", "Netherlands",  target="_blank"),
      ", ",
      tags$a(href = "https://www.medrxiv.org/content/10.1101/2020.05.22.20109793v1", "Denmark",  target="_blank"),
      ",  and ",
      tags$a(href = "https://gh.bmj.com/content/5/9/e003075", "Ireland",  target="_blank"),
