...
output$top_commentary <- renderUI({
  tagList(
    ...
    p("The data shows that, at all Scotland level, the number of terminations of pregnancy provided month by month was broadly consistent from January 2018 (when the data shown starts) to February 2020 inclusive.  The number of terminations was then higher than usual in March and April 2020, before falling to lower than usual levels in May, June, and July 2020 (with July 2020 being the latest month for which data are currently available).  Over March and April 2020, around 500 more terminations than would have been expected based on pre-pandemic average levels were provided in Scotland.  This is likely to reflect a higher proportion than usual of women who found they were pregnant at the start of the COVID-19 pandemic in Scotland choosing not to continue with their pregnancy.  As discussed in the Commentary on the Antenatal booking data (link) provided through this tool, it is likely that the lower than usual numbers of termination provided from May 2020 onwards reflects a reduction in the number of women falling pregnant from April 2020 onwards.  Further analysis is required to accurately examine trends in the number of women falling pregnant during the COVID-19 pandemic, their subsequent choices to continue with or terminate their pregnancy, and what this means for future trends in the number of births in Scotland."),
