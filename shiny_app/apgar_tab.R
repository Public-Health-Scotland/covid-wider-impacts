...
output$apgar_commentary <- renderUI({
  tagList(
    ...
    h2("Apgar scores - 3rd August 2021"),
    p("Data are thought to be incomplete for NHS Fife in April 2022, so the proportion of babies with a low Apgar score this month is likely to change in future releases of the dashboard. Data submissions from NHS Forth Valley were insufficient to report for April 2022. These will be updated in future dashboard releases."),
