...
output$apgar_commentary <- renderUI({
  tagList(
    ...
    p("Data are thought to be incomplete for NHS Fife and NHS Forth Valley in April 2022, so the proportion of babies with a low Apgar score this month is likely to change in future releases of the dashboard."),
