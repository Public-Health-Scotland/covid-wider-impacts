...
prepare_final_data(ae_data, "ae", last_week = "2020-08-16")
...
prepare_final_data(ae_cardio, "ae_cardio", last_week = "2020-08-16")

###############################################.
## Prescribing - Cardiovascular Drugs ----
###############################################.
cardio_drugs <- read_xlsx(paste0(data_folder, "prescribing_cardio/covid emessage AMS only 20200820.xlsx")) %>% 
  select(1:5) %>% 
  clean_names() %>% 
...
prepare_final_data(cardio_drugs, "cardio_drugs", last_week = "2020-08-16")
