...
ae_data <- rbind(read_csv(unz(paste0(ae_folder,"2020-11-24-HSCP-ED-Attendances-SIMD-AgeBand-COVID-19-Publication.zip"),
                              "HSCP.csv")) %>% 
                   janitor::clean_names() %>% 
                   rename(area=hscp_of_residence_code_as_at_arrival_date),
                 read_csv(unz(paste0(ae_folder,"2020-11-24-NHSBoard-ED-Attendances-SIMD-AgeBand-COVID-19-Publication.zip"), 
                              "NHS Boards.csv")) %>% 
                   janitor::clean_names() %>% 
...
ae_cardio <- read_xlsx(paste0(ae_folder, "2020-11-24-CardioVascular-AttendancesDuringCovid-19.xlsx")) %>% 
  clean_names() %>% 
