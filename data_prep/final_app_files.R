...
save_final_file("six_alldose", "23_Mar_21")
save_final_file("six_dose1_simdtable", "23_Mar_21")
save_final_file("six_dose2_simdtable", "23_Mar_21")
save_final_file("six_dose3_simdtable", "23_Mar_21")
save_final_file("sixinone_datatable", "23_Mar_21")
## Immunisations - MMR ----
save_final_file("mmr_alldose", "23_Mar_21")
save_final_file("mmr_dose1_simdtable", "23_Mar_21")
save_final_file("mmr_dose2_simdtable", "23_Mar_21")
save_final_file("mmr_datatable", "23_Mar_21")
save_final_file("mmr_dose2_grampian_datatable", "23_Mar_21")
# Immunisations - definitions
save_final_file("age_defs_imm_6inone", "23_Mar_21")
save_final_file("age_defs_imm_mmr", "23_Mar_21")
save_final_file("month_eligibility_immun", "23_Mar_21")
##########################################################.
