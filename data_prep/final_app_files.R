...
##########################################################.
## RAPID ----
save_final_file("rapid", "29_Nov_21")
save_final_file("spec_lookup_rapid", "09_Mar_21")
## OOH ----
save_final_file("ooh", "29_Nov_21")
## A&E ----
save_final_file("ae", "29_Nov_21")
## NHS24 ----
save_final_file("nhs24", "29_Nov_21")
## SAS ----
...
## Cardio - A&E ----
save_final_file("ae_cardio", "29_Nov_21")
save_final_file("ae_cardio_codes", "30_Nov_20")
## Cardio - OOH ----
save_final_file("ooh_cardiac", "29_Nov_21")
## Cardio - SAS ----
...
##########################################################.
## Drugs - substance use ----
save_final_file("ADP_names", "25_Mar_21")
save_final_file("Health_board", "25_Mar_21")
save_final_file("DTR_data", "25_Mar_21")
save_final_file("THN_by_HB", "25_Mar_21")
save_final_file("OST_paid", "25_Mar_21")
save_final_file("OST_paid_quantity", "25_Mar_21")
