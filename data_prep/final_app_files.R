...
##########################################################.
## SACT ----
save_final_file("sact_data", "04_Jul_22")
save_final_file("sact_weekly_data", "04_Jul_22")
...
save_final_file("cardio_drugs", "01_Jul_22") # prescribing
...
##########################################################.
## Mental health  ----
save_final_file("mentalhealth_drugs", "01_Jul_22") # Prescribing
