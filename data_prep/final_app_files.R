...
save_final_file("first_visit", "28_Apr_22")
save_final_file("first_visit_datatable", "28_Apr_22")
save_final_file("first_visit_data", "28_Apr_22")
## Child health reviews - 6-8 weeks ----
save_final_file("six_to_eight", "28_Apr_22")
save_final_file("six_to_eight_datatable", "28_Apr_22")
save_final_file("six_to_eight_data", "28_Apr_22")
## Child health reviews - 13-15 months ----
save_final_file("thirteen", "28_Apr_22")
save_final_file("thirteen_datatable", "28_Apr_22")
save_final_file("thirteen_data", "28_Apr_22")
## Child health reviews - 27-30 months ----
save_final_file("twentyseven", "28_Apr_22")
save_final_file("twentyseven_datatable", "28_Apr_22")
save_final_file("twentyseven_data", "28_Apr_22")
## Child health reviews - 4-5 years ----
save_final_file("fourtofive", "28_Apr_22")
save_final_file("fourtofive_datatable", "28_Apr_22")
save_final_file("fourtofive_data", "28_Apr_22")
## Child development ----
save_final_file("child_dev", "28_Apr_22")
save_final_file("child_dev_depr", "28_Apr_22")
save_final_file("child_dev_domains", "28_Apr_22")
## Breastfeeding ----
save_final_file("breastfeeding", "28_Apr_22")
##########################################################.
