...
##########################################################.
## SACT ----
save_final_file("sact_data", "16_Aug_21")

save_final_file("sact_weekly_data", "16_Aug_21")
...
save_final_file("ante_booking", "16_Aug_21")
save_final_file("ante_booking_download", "16_Aug_21")
...
## B&B - Apgar ----
save_final_file("apgar_runchart_data", "20_Aug_21")
save_final_file("apgar_scot_data", "20_Aug_21")
save_final_file("apgar_linechart_data", "20_Aug_21")
save_final_file("apgar_download_data", "20_Aug_21")
## B&B - Preterm ----
save_final_file("preterm_linechart_data", "28_Jun_21")
save_final_file("preterm", "28_Jun_21")
## B&B - Tears ----
save_final_file("tears_runchart_data", "20_Aug_21")
save_final_file("tears_scot_data", "20_Aug_21")
save_final_file("tears_linechart_data", "20_Aug_21")
save_final_file("tears_download_data", "20_Aug_21")
##########################################################.
