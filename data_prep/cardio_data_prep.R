...
## OOH Cardiac  ----
###############################################.
create_oohcardio <- function(filedate, last_week, comparison_end = NULL) {
  ...
  prepare_final_data_cardiac(dataset = ooh_cardiac, filename = "ooh_cardiac",
                             last_week = last_week, comparison_end = comparison_end)
