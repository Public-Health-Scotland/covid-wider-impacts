...
create_tears(tears_date = "2022_04_13", max_date = "2021-12-01") # Perineal tears
...
create_aecardio(filedate = "2022-03-31", last_week =  "2022-03-27")
...
create_chreview(ch_date_file = "20220328") # Child health reviews. #date included in filepath name
create_childdev(filedate = "28thMar2022")
create_breastfeeding(filedate = "28thMar2022")
create_childdev_domains(filedate="28thMar2022")
...
create_rapid(last_week =  "2022-03-27", extract = T) # this requires access to the RAPID dataset
create_ae(filedate = "2022-03-31", last_week =  "2022-03-27")
create_ooh(filename = "WIDER IMPACT PC OOH Data_67_4283524410165890434", last_week = "2022-03-20")
create_nhs24(filedate = "2022-04-04", last_week =  "2022-03-27")
...
create_antebooking(booking_date = "13042022", max_book_date = "2022-03-28")
