...
create_sascardio(filedate = "2022-01-31", last_week =  "2022-01-23")
...
create_rapid(last_week =  "2022-01-02", extract = T) # this requires access to the RAPID dataset
create_ae(filedate = "2022-01-13", last_week =  "2022-01-02")
