...
p_perinatal <- bind_rows(read_excel(paste0(data_folder,"perinatal/Pchart - SB NND EXTPERII_aprupdate.xlsx"),
                                    sheet = "Stillbirth", skip = 2) %>% mutate(type = "stillbirths"),
                         read_excel(paste0(data_folder,"perinatal/Pchart - SB NND EXTPERII_aprupdate.xlsx"),
...
u_perinatal <- bind_rows(read_excel(paste0(data_folder,"perinatal/Uchart - PNND INFANT DEATHS_aprupdate.xlsx"),
                          sheet = "ID", skip = 2) %>% mutate(type = "infantdeaths"),
                         read_excel(paste0(data_folder,"perinatal/Uchart - PNND INFANT DEATHS_aprupdate.xlsx"),
