...
if (sessionInfo()$platform %in% c("x86_64-redhat-linux-gnu (64-bit)", "x86_64-pc-linux-gnu (64-bit)")) {
  ...
  ae_folder <- "/conf/PHSCOVID19_Analysis/UCD/A&E/Test/" #short cut to a&e folder areas
  ...
  ae_folder <- "//Isdsf00d03/PHSCOVID19_Analysis/UCD/A&E/Test/" #short cut to a&e folder areas
